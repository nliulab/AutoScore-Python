...
def load_sample_data(dataset):
    ...
    """
    url_dict = {'binary': 'https://raw.githubusercontent.com/nliulab/AutoScore-Python/main/data/sample_data.csv',
                'small': 'https://raw.githubusercontent.com/nliulab/AutoScore-Python/main/data/sample_data_small.csv',
                'missing': 'https://raw.githubusercontent.com/nliulab/AutoScore-Python/main/data/sample_data_with_missing.csv'}
    if dataset in url_dict:
        data = pd.read_csv(url_dict[dataset], index_col=0)
    else:
